...
class FasterMonster(Monster):
    def counterattack(self, altman):
        altman.blood = altman.blood - self.attackPower * 1 / 2.0
        altman.blood -= self.attackPower / 2.0 / 2

class PowerMonster(Monster):
    def counterattack(self, altman):
        altman.blood -= self.attackPower * 1.0
...
if __name__ == "__main__":
    altman = Altman()
    monster = [Monster(12, 5), Monster(22, 15), FasterMonster(28, 15), PowerMonster(33, 50)]
    print "------------------------游戏开始----------------------------"
    game(altman, monster)